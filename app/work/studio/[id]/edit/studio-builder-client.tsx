...
function StepCard({
  step, index, total, agents, onUpdate, onRemove, onMove,
}: {
  step: WorkflowStep;
  index: number;
  total: number;
    ...
    <>
      <Field label="Instruction">
        <textarea
          ...
          rows={4}
          className="w-full px-3 py-2 border border-neutral-200 rounded-md text-[13px] resize-y focus:outline-none focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400"
        />
      </Field>
