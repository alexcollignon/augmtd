...
import { INTEGRATIONS, isKnownProvider, slackKeyForRole, coworkerEmailForRole } from '@/lib/integrations/registry';
...
export async function GET(_req: NextRequest, { params }: Params) {
  ...
  try {
    ...
    // Email is always available (no OAuth) but OFF by default — append it as its own card.
    tools.push({
      provider: 'email',
      name: 'Email',
