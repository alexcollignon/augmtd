...
export * from './types';
// W16 · THE ITEM PAGE IS A FEW KIT WIDGETS — the one composition + the kit's confirm widget (W16.2: the `confirm` kind).
export { composeItemPage, actionOf, actionWidgetOf, claraSentenceOf, itemPageItems, actionCardOf, ITEM_ACTION_WIDGETS, WIDGET_OF_ARTIFACT, ARTIFACTS_OF_STATE, NOT_ITEM_PAGE_WIDGETS, CONFIRM_WORDS } from './item-page';
